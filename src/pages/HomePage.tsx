...
const categories = [
  { name: 'Business', count: 245, color: 'bg-blue-50 text-blue-600 dark:bg-blue-950 dark:text-blue-400' },
  { name: 'Portfolio', count: 189, color: 'bg-purple-50 text-purple-600 dark:bg-purple-950 dark:text-purple-400' },
  { name: 'Landing', count: 312, color: 'bg-green-50 text-green-600 dark:bg-green-950 dark:text-green-400' },
  { name: 'E-Commerce', count: 98, color: 'bg-amber-50 text-amber-600 dark:bg-amber-950 dark:text-amber-400' },
  { name: 'Blog', count: 134, color: 'bg-pink-50 text-pink-600 dark:bg-pink-950 dark:text-pink-400' },
  { name: 'SaaS', count: 87, color: 'bg-cyan-50 text-cyan-600 dark:bg-cyan-950 dark:text-cyan-400' },
]

const featuredTemplates = [
  { name: 'Portfolio 2', description: 'Modern portfolio template for creatives', framework: 'Next.js', tier: 'free' as const },
  { name: 'Busicol', description: 'Business landing page template', framework: 'Next.js', tier: 'free' as const },
  { name: 'OnlineEdu', description: 'E-learning platform template', framework: 'Next.js', tier: 'premium' as const },
  { name: 'Sintec', description: 'Construction company website', framework: 'Next.js', tier: 'free' as const },
  { name: 'OnePro', description: 'One-page business template', framework: 'Next.js', tier: 'free' as const },
  { name: 'AppPro', description: 'SaaS application landing page', framework: 'Gatsby.js', tier: 'premium' as const },
]
    ...
    <div>
        ...
        <div className="relative mx-auto max-w-7xl px-4 py-20 sm:px-6 sm:py-28 lg:px-8">
          <div className="mx-auto max-w-3xl text-center">
            <h1 className="text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl dark:text-white">
              1,000+ Free Website
              <span className="bg-gradient-to-r from-primary-600 to-accent-500 bg-clip-text text-transparent"> Templates</span>
            </h1>
            <p className="mt-6 text-lg text-gray-600 dark:text-gray-300">
              Jumpstart your next project with production-ready templates for Next.js, Gatsby.js, Nuxt.js, and more. Free and premium starter templates for every need.
            </p>
      ...
      <section className="border-b border-gray-200 py-16 dark:border-gray-800">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <p className="mt-2 text-gray-600 dark:text-gray-400">Find the perfect template for your project.</p>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="mt-2 text-gray-600 dark:text-gray-400">Hand-picked templates to get you started.</p>
            </div>
            <Link to="/templates">
          ...
          <div className="mt-8 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {featuredTemplates.map((tmpl) => (
              <div key={tmpl.name} className="group rounded-xl border border-gray-200 bg-white p-6 transition-all hover:-translate-y-1 hover:shadow-lg dark:border-gray-800 dark:bg-gray-900">
                {/* Preview placeholder */}
      ...
      <section className="bg-gradient-to-r from-primary-600 to-primary-800 py-16">
        <div className="mx-auto max-w-7xl px-4 text-center sm:px-6 lg:px-8">
          ...
          <p className="mx-auto mt-4 max-w-2xl text-lg text-primary-100">
            Get unlimited access to all premium templates, priority support, and early access to new releases.
          </p>
          <div className="mt-8">
            <Link to="/pricing">
