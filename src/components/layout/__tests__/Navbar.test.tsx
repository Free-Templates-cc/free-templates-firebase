...
describe('Navbar', () => {
  ...
  it('renders the logo with brand name', () => {
    ...
    // The logo contains 'Free' and 'Templates' in nested spans
  ...
  it('renders navigation links', () => {
    renderWithRouter(<Navbar />)
    // Use nav links rather than text to avoid logo/nav collision
  ...
  it('shows mobile search and nav links when mobile menu is open', () => {
    ...
    renderWithRouter(<Navbar />)
    // In mobile menu, Templates and Pricing links should still be present
